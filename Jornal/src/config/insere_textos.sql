...
CREATE DATABASE db_jornal_sesi_testes;
USE db_jornal_sesi_testes;
...
-- 1. CADASTRO DE AUTORES (TODOS DO 3ºB E SEM DESCRIÇÃO)
...
-- 2. PUBLICAÇÕES (CONTÉUDO INTEGRAL COM IDS CORRIGIDOS)
